...
\end{figure}	
	...
	Simultáneamente, LoRaWAN se consolida como una infraestructura vital parademocratizar la conectividad en sectores productivos rurales o de difícil acceso, donde el despliegue celular resulta económicamente inviable o presenta marcados vacíos de cobertura. De este modo, la especialización funcional de cada tecnología permitirá reducir las brechas digitales y potenciar un desarrollo tecnológico equitativo.
	...
	\begin{figure}[H]
		\caption{\textit{Representación del tamaño de las celdas en una red celular según la densidad de usuarios}}
		\centering
		\includegraphics[width=0.8\textwidth]{imagenes/celdas.png}
	\end{figure}
	
	\begin{figure}[H]
		\caption{\textit{BTS en configuración estándar}}
		\centering
		\includegraphics[width=0.6\textwidth]{imagenes/BTS.jpg}
	\end{figure}
	\pagebreak
	...
	\begin{figure}[H]
		\caption{\textit{Interacción entre HLR y VLR en la red GSM}}
		\centering
		\includegraphics[width=0.7\textwidth]{imagenes/vlryhlr.png}
	\end{figure}
	
	\begin{figure}[H]
		\caption{\textit{Arquitectura de la red GSM}}
		\centering
		\includegraphics[width=0.7\textwidth]{imagenes/gsmArq.png}
	\end{figure}
	\pagebreak
	...
	\begin{figure}[H]
		\caption{\textit{Espectrograma de un símbolo individual (chirp) en modulación CSS}}
		\centering
		\includegraphics[width=0.7\textwidth]{imagenes/ondaIndividualFIG2ENRIQUE.png}
	\end{figure}
	
	\begin{figure}[H]
		\caption{\textit{Representación del valor en bits de un símbolo y la influencia del spreading factor, la cual denota información captada}}
		\centering
		\includegraphics[width=1.1\textwidth]{imagenes/representacionChipsyChirpsSimboloFIG3ENRIQUE.png}
	\end{figure}
	\pagebreak
	
	\begin{figure}[H]
		\caption{\textit{Diferencia entre LoRa y su protocolo LoRaWAN, graficado en un diagrama secuencial}}
		\centering
		\includegraphics[width=0.9\textwidth]{imagenes/estructuraLoRaYLoRaWANFIG4ENRIQUE.png}
	\end{figure}
	
	\begin{figure}[H]
		\caption{\textit{Aplicaciones más comunes de LoRaWAN en los prospectos de ciudades inteligentes}}
		\centering
		\includegraphics[width=1.0\textwidth]{imagenes/tiposDeAplicacionesGlobalesFIG5ENRIQUE.png}
	\end{figure}
	\pagebreak
	...
	\begin{figure}[H]
		\caption{\textit{Bandas espectrales asignadas en la región}}
		\centering
		\includegraphics[width=1.1\textwidth]{imagenes/BandasEspectrales3G-4G-5G.JPG}
	\end{figure}
	
	\begin{figure}[H]
		\caption{\textit{Arquitectura de la Red 3G}}
		\centering
		\includegraphics[width=1.1\textwidth]{imagenes/Arq-3G.JPG}
	\end{figure}
	\pagebreak
	...
	\begin{figure}[H]
		\caption{\textit{Cobertura de la Red 3G}}
		\centering
		\includegraphics[width=0.6\textwidth]{imagenes/3G.JPG}
	\end{figure}
	
	\begin{figure}[H]
		\caption{\textit{Arquitectura de la Red 4G}}
		\centering
		\includegraphics[width=0.9\textwidth]{imagenes/ARQ-4G.JPG}
	\end{figure}
	\pagebreak
	...
	\begin{figure}[H]
		\caption{\textit{Cobertura de la Red 4G}}
		\centering
		\includegraphics[width=0.6\textwidth]{imagenes/4G.JPG}
	\end{figure}
	
	\begin{figure}[H]
		\caption{\textit{Arquitectura de la Red 5G}}
		\centering
		\includegraphics[width=1.0\textwidth]{imagenes/Arq-5G.JPG}
	\end{figure}
	\pagebreak
	...
	\begin{figure}[H]
		\caption{\textit{Comparativa de las redes 2G, 3G, 4G y 5G en el Perú}}
		\centering
		\includegraphics[width=1.1\textwidth]{imagenes/CompUrb-Rural.JPG}
	\end{figure}
	\pagebreak
	...
	\begin{figure}[H]
		\caption{}
		\centering
		\includegraphics[width=1\textwidth]{imagenes/ejemploOndasRealesCaptadas FIG6ENRIQUE.png}
		\par
		\vspace{0.3cm}
		\raggedright
	\end{figure}
	...
	\begin{table}[H]
		\flushleft
		\textbf{Tabla 1} \\ 
		\textit{Análisis comparativo entre tecnologías GSM/GPRS y LoRa} 
	...
	\begin{enumerate}
    \item Actility. (s.f.). Seguridad LoRaWAN. \url{https://www.actility.com/es/seguridad-lorawan/}
    \item Ascarrunz, M. M. (2025). Limitaciones burocráticas en infraestructura pasiva de telecomunicaciones en Lima Metropolitana (2021–2024). IUSTITIA, 23(26), 71-132. \url{https://revistas.ustabuca.edu.co/index.php/IUSTITIA/article/view/3260}
    \item Bassi, A. (2021). Intro a la tecnología LoRa. Goto IoT. \url{https://www.gotoiot.com/pages/articles/lora_intro/index.html}
    \item Bassi, A. (2021). Introducción a LoRaWAN. GoTo IoT. \url{https://www.gotoiot.com/pages/articles/lorawan_intro/content.html}
    \item Becvar, Z., Mach, P., Pravda, I., \& Becvar, A. Z. (2013). Redes móviles. Redes móviles, 11-12. \url{https://techpedia.fel.cvut.cz/project/modules/improvet/download/C4ES/Redes_moviles.pdf}
    \item Beierle, C., Leander, G., \& Moradi, A. (2021). Cryptanalysis of the GPRS encryption algorithms GEA-1 and GEA-2. Advances in Cryptology – EUROCRYPT 2021. Springer. \url{https://dl.acm.org/doi/abs/10.1007/978-3-030-77886-6_6}
    \item Bergström, J., von Butovitsch, P., Ekelund, B., Gustafsson, K., \& Lundsjö, J. (2024). The history of mobile internet: The technology transformation that changed the lives of billions. Ericsson Technology Review. \url{https://www.ericsson.com/en/reports-and-papers/ericsson-technology-review/articles/mobile-miracles}
    \item Bettstetter, C., Vogel, H.-J., \& Eberspächer, J. (1999). GSM Phase 2+ General Packet Radio Service GPRS: Architecture, protocols, and air interface. IEEE Communications Surveys \& Tutorials. \url{http://www.comlab.hut.fi/opetus/423/a_a/Bettstetter.pdf}
    \item Bohórquez, M. Á. M., Cuesta, E. P. E., \& Quintero, J. C. M. 5G En América. \url{https://publicaciones.unad.edu.co/index.php/wpecbti/article/view/4809}
    \item Botran Fernández, X. (2022). Implementación de un prototipo de receptor para canal PDSCH de 5G NR sobre dispositivo comercial de bajo coste RTL-SDR. \url{https://www.researchgate.net/publication/364103828_Implementacion_de_un_prototipo_de_receptor_para_canal_PDSCH_de_5G_NR_sobre_dispositivo_comercial_de_bajo_coste_RTL-SDR}
    \item Brecha digital móvil en centros poblados del Perú 2023 y sus determinantes territoriales. (2026). C\&T Riqchary Revista De investigación En Ciencia Y tecnología, 8(1), 21-27. \url{https://revistas.unamba.edu.pe/index.php/riqchary/article/view/253}
    \item Cai, J., \& Goodman, D. J. (1997). General Packet Radio Service in GSM. SciSpace. \url{https://scispace.com/pdf/general-packet-radio-service-in-gsm-401o5ipao5.pdf}
    \item Carbonell, M. A. C. Viabilidad tecno-económica de las redes LTE y 5G en Perú acorde a los. Desafíos, 1, 3-81. \url{https://oa.upm.es/90151/1/MICHAEL_ALEJANDRO_CABANILLAS_CARBONELL_2.pdf}
    \item Casado, E. (2026). LoRa y LoRaWAN: conectividad IoT de largo alcance y bajo consumo. \url{https://adictosaltrabajo.com/2026/02/23/lora-y-lorawan-conectividad-iot-de-largo-alcance-y-bajo-consumo/}
    \item Castilla Sierra, R. M., \& Meza Jiménez, V. M. (2005). Descripción y evolución de tecnologías para redes de datos en ambiente GSM. \url{https://repositorio.utb.edu.co/server/api/core/bitstreams/b5bce8fb-a2c1-4e66-b700-eb89bcd31735/content}
    \item Churi, J. R., Surendran, T. S., Tigdi, S. A., \& Yewale, S. (2012, August). Evolution of networks (2G-5G). In International Conference on Advances in Communication and Computing Technologies (ICACACT) (Vol. 51, No. 4, pp. 8-13). \url{https://www.ijcaonline.org/proceedings/icacact/number3/7980-1016/}
    \item Cifuentes, S., Pacheco, L., Argandoña, D., Tamayo, L., Obregón, R., Tafur, J., \& Camero, P. (2014). Infraestructura de redes móviles en el Perú: Análisis y recomendaciones para promover su mejora. Lima: OSIPTEL. \url{https://sociedadtelecom.pe/libros-osiptel/wp-content/uploads/2019/05/infraestructura-redes.pdf}
    \item Cloud Studio IoT. (2026, 10 de julio). LoRaWAN para Smart Cities: Arquitectura y casos de uso. Cloud Studio IoT Hub. \url{https://cloudstudioiot.com/es/hub/lorawan-smart-cities}
    \item Constain Prado, D. D. (2019). Cobertura y capacidad en redes 2G, 3G y 4G. \url{https://repository.udistrital.edu.co/server/api/core/bitstreams/8557a25e-4b06-4131-bfff-4cda6da4fb0a/content}
    \item Cox, C. (2025). An Introduction to 5G: The New Radio, 5G Network, 5G Advanced and Beyond. John Wiley \& Sons. \url{https://books.google.com.ec/books?id=q0VWEQAAQBAJ&printsec=frontcover&hl=es&source=gbs_ge_summary_r&cad=0#v=onepage&q&f=false}
    \item Danish, S. M., Nasir, A., Qureshi, H. K., Ashfaq, A. B., Mumtaz, S., \& Rodriguez, J. (2018). Network intrusion detection system for jamming attack in LoRaWAN join procedure. IEEE International Conference on Communications (ICC). \url{https://doi.org/10.1109/ICC.2018.8422721}
    \item Devasia, N. (2026). Estadísticas y tendencias de crecimiento de dispositivos IoT (2026). The Network Installers. \url{https://thenetworkinstallers.com/es/blog/Estad%C3%ADsticas-de-crecimiento-de-dispositivos-IoT/}
    \item Dossa, A., \& Amhoud, E. M. (2025). Impact of reactive jamming attacks on LoRaWAN: A theoretical and experimental study (arXiv:2501.18339v2). arXiv. \url{https://doi.org/10.48550/arXiv.2501.18339}
    \item Edu Area. (2015). eCity: Telefonía móvil, conceptos básicos [Vídeo]. YouTube. \url{https://youtu.be/y-q6AqLazGo}
    \item European Telecommunications Standards Institute. (1996). Digital cellular telecommunications system (Phase 2+); Network architecture (GSM 03.02) (GSM 03.02 version 5.1.0). ETSI. \url{https://www.etsi.org/deliver/etsi_gts/03/0302/05.01.00_60/gsmts_0302v050100p.pdf}
    \item Fay, M., \& Yepes, T. (2003). Investing in infrastructure: What is needed from 2000 to 2010? The World Bank. \url{https://hdl.handle.net/10986/18147}
    \item Flores, J. (diciembre, 2022). Qué es el 5G y cómo nos cambiará la vida. National Geographic. \url{https://www.nationalgeographic.com.es/ciencia/que-es-5g-y-como-nos-cambiara-vida_14449}
    \item Galindo Pérez, M. C., \& Olmedo Neri, R. A. (2025). Brecha digital de cobertura. Una estimación mediante las redes 2G, 3G y 4G para México. Investigaciones geográficas, (118). \url{https://www.scielo.org.mx/scielo.php?pid=S0188-46112025000300108&script=sci_arttext}
    \item García Fernández, A., Pina Amargós, J. D., \& Leyva Pérez, E. C. (2007). ESTADO DEL ARTE DE LAS REDES INALÁMBRICAS. Ingeniería Industrial, XXVIII(3), 50-56. \url{https://www.redalyc.org/pdf/3604/360433564001.pdf}
    \item Garg, V. K., Wilkes, J. E., \& Smolik, K. (2002). Mobile network evolution: A revolution on the move. IEEE Communications Magazine. \url{https://sites.pitt.edu/~dtipper/3G_evol_paper.pdf}
    \item Gomstyn, A., \& Jonker, A. (s. f.). ¿Qué es una ciudad inteligente? IBM Think. \url{https://www.ibm.com/es-es/think/topics/smart-city}
    \item González Betancourt, D. A. Análisis de seguridad en Redes Lora. \url{https://ridum.umanizales.edu.co/items/acb457f7-6da7-4117-83e5-2ef80005c45c}
    \item Heine, G. (1999). GSM networks: Protocols, terminology, and implementation. Artech House. \url{https://kolegite.com/EE_library/books_and_lectures/%D0%9A%D0%BE%D0%BC%D1%83%D0%BD%D0%B8%D0%BA%D0%B0%D1%86%D0%B8%D0%BE%D0%BD%D0%BD%D0%B0%20%D1%82%D0%B5%D1%85%D0%BD%D0%B8%D0%BA%D0%B0/GSM%20Networks%20-%20Protocols%2C%20Terminology%20and%20Implementation.pdf}
    \item Hessel, F., Almon, L., \& Hollick, M. (2023). LoRaWAN Security: An Evolvable Survey on Vulnerabilities, Attacks and their Systematic Mitigation. ACM Transactions on Sensor Networks. \url{https://doi.org/10.1145/3561973}
    \item Horn, R. (2021). Actualizaciones de desactivación de la red LTE 2G, 3G, 4G. Revista española de electrónica, (797), 42-45. \url{https://www.redeweb.com/ficheros/Abril2021.pdf}
    \item Huidobro Moya, J. M. (2020). Las telecomunicaciones. Una herramienta esencial para los autores. Acta. \url{https://www.acta.es/medios/informes/2020006.pdf}
    \item IBM. (s. f.). What is the Internet of Things (IoT)? IBM Think. \url{https://www.ibm.com/think/topics/internet-of-things}
    \item IoT Lab. (2025, 25 de marzo). LoRaWAN desde CERO: Todo lo que necesitas saber [Video]. YouTube. \url{https://www.youtube.com/watch?v=O4jI64kuDUs}
    \item Izertis. (2020). Redes IoT: desde GPRS, Sigfox, LoRA, Nb-IoT hasta 5G. \url{https://www.izertis.com/es/w/blog/redes-iot-desde-gprs-sigfox-lora-hasta-5g}
    \item Jack, W., \& Suri, T. (2014). Risk sharing and transactions costs: Evidence from Kenya's mobile money revolution. American Economic Review. \url{https://poverty-action.org/sites/default/files/2023-08/jack_suri_aer_.pdf}
    \item Jaramillo Lojan, A. F., \& Navarrete Cañart, P. A. (2021). Análisis comparativo entre tecnologías LoRaWAN y GSM/GPRS a fin de evaluar métricas como el rendimiento, consumo de energía y cobertura para transmisiones de datos en escenarios IoT (Bachelor's thesis). \url{https://dspace.ups.edu.ec/bitstream/123456789/20586/1/UPS%20-%20TTS401.pdf}
    \item Karakoc, B., Fürste, N., Rupprecht, D., \& Kohls, K. (2023). Never let me down again: Bidding-down attacks and mitigations in 5G and 4G. ResearchGate. \url{https://doi.org/10.1145/3558482.3590196}
    \item Lin, Y.-B., Rao, H. C.-H., \& Chlamtac, I. (2001). General Packet Radio Service (GPRS): Architecture, protocols, and air interface. Wireless Communications and Mobile Computing. \url{https://www.3g4g.co.uk/GsmGprsEdge/gprs001.pdf}
    \item Londono, D. S. ANTENAS EN LOS SISTEMAS DE COMUNICACIONES MOVILES. \url{https://www.academia.edu/download/53362711/Antenas_celular.pdf}
    \item López, A. (2018). Telefonía móvil: Las empresas que fueron "absorbidas" en el Perú. Mercado Negro. \url{https://www.mercadonegro.pe/medios/informes/telefonia-movil-las-empresas-que-fueron-absorbidas-en-el-peru/}
    \item LoRa Alliance. (s. f.). About LoRa Alliance. \url{https://lora-alliance.org/about-lora-alliance/}
    \item LoRa Alliance. (2026). LoRa Alliance unveils 3-year roadmap for scaling LoRaWAN globally. \url{https://lora-alliance.org/lorawan-news/lora-alliance-unveils-3-year-roadmap-for-scaling-lorawan-globally/}
    \item Mayorquín, D. (2024, 7 de octubre). Importancia de la banda ISM en el desarrollo de dispositivos electrónicos para IoT. CIDEI. \url{https://cidei.net/importancia-de-la-banda-ism/}
    \item Ministerio de Desarrollo Agrario y Riego. (2021). Midagri: Perú tiene una superficie agrícola de 11.6 millones de hectáreas a nivel nacional. El Peruano. \url{https://elperuano.pe/noticia/113806-midagri-peru-tiene-una-superficie-agricola-de-116-millones-de-hectareas-a-escala-nacional}
    \item Mishra, A. (2001). Performance and architecture of SGSN and GGSN of general packet radio service (GPRS). GLOBECOM'01. IEEE Global Telecommunications Conference. \url{https://doi.org/10.1109/GLOCOM.2001.966331}
    \item Mobilefish.com. (2018). Tutorial 13 de LoRa/LoRaWAN: Símbolo, factor de expansión y chip [Video]. YouTube. \url{https://www.youtube.com/watch?v=0FCrN-u-Vpw}
    \item Mordor Intelligence. (2024). Mercado de conectividad IoT LoRa y LoRaWAN: Tamaño, participación y análisis de la industria (2025–2030). \url{https://www.mordorintelligence.ar/industry-reports/lora-and-lorawan-iot-connectivity-market}
    \item Moy Kwan, H. F., \& Carrillo Paz, A. J. (2009). INTEGRACIÓN DE LA TECNOLOGÍA GPRS EN REDES GSM. Télématique, 8(1), 24-41. \url{https://www.redalyc.org/pdf/784/78411785002.pdf}
    \item Nota de prensa (octubre, 2025). MTC y operadores abordaron agenda sobre renovación de concesiones, apagón 2G y canon móvil. Gob.pe. \url{https://www.gob.pe/institucion/mtc/noticias/1269621-mtc-y-operadores-abordaron-agenda-sobre-renovacion-de-concesiones-apagon-2g-y-canon-movil}
    \item Nota de prensa (2026). Expansión de antenas 4G se consolida y supera las 64 000 en 2025. Gob.pe. \url{https://www.gob.pe/institucion/mtc/noticias/1351970-expansion-de-antenas-4g-se-consolida-y-supera-las-64-000-en-2025}
    \item Nota de prensa (2026). Más de 67 mil peruanos accedieron a servicios móviles 4G gracias al cumplimiento de compromisos del Canon por Cobertura. Gob.pe. \url{https://www.gob.pe/institucion/mtc/noticias/1218088-mas-de-67-mil-peruanos-accedieron-a-servicios-moviles-4g-gracias-al-cumplimiento-de-compromisos-del-canon-por-cobertura}
    \item Nota de prensa (2026). MTC impulsa nueva regulación para acelerar el despliegue de infraestructura de telecomunicaciones. Gob.pe. \url{https://www.gob.pe/institucion/mtc/noticias/1401569-mtc-impulsa-nueva-regulacion-para-acelerar-el-despliegue-de-infraestructura-de-telecomunicaciones}
    \item Nota de prensa (2026). MTC promovió expansión de servicio móvil 4G en beneficio de más de 82 mil pobladores de la región San Martín. Gob.pe. \url{https://www.gob.pe/institucion/mtc/noticias/1394735-mtc-promovio-expansion-de-servicio-movil-4g-en-beneficio-de-mas-de-82-mil-pobladores-de-la-region-san-martin}
    \item Nota de prensa (2026). Perú acelera el despliegue de 5G con más de 3,800 antenas instaladas. Gob.pe. \url{https://www.gob.pe/institucion/mtc/noticias/1371695-peru-acelera-el-despliegue-de-5g-con-mas-de-3-800-antenas-instaladas}
    \item Ntshabele, K., Isong, B., Gasela, N., \& Abu-Mahfouz, A. M. (2022). A Comprehensive Analysis of LoRaWAN Key Security Models and Possible Attack Solutions. Mathematics. \url{https://doi.org/10.3390/math10193421}
    \item Ordóñez Monfort, I. (2017). Estudio de la arquitectura y el nivel de desarrollo de la red LoRaWAN y de los dispositivos LoRa. \url{https://openaccess.uoc.edu/server/api/core/bitstreams/0707403b-a007-49c5-95dc-2d31676b3c58/content}
    \item Organismo Supervisor de Inversión Privada en Telecomunicaciones. (2025). Legislación en Telecomunicaciones. Gob.pe. \url{https://www.gob.pe/institucion/osiptel/informes-publicaciones/7301378-legislacion-en-telecomunicaciones}
    \item OSIPTEL. FUNCIONES DEL OSIPTEL. OSIPTEL. \url{https://www.osiptel.gob.pe/informacion-institucional/funciones-del-osiptel/}
    \item Pérez, C., \& Risco, J. (s.f.). Implementación de LoRa y LoRaWAN como escenario futuro de la industria 4.0 en el sector agroindustrial peruano. Universidad de San Martín de Porres. \url{https://www.usmp.edu.pe/campus/pdf/articulos/articulo_20.pdf}
    \item Poole, I. (s.f.). GSM Network Architecture. Electronics Notes. \url{https://www.electronics-notes.com/articles/connectivity/2g-gsm/network-architecture.php}
    \item Rehman Zafar, Mahmood, A., Razzaq, S., Ali, W., Naeem, U., \& Shehzad, K. (2018). Prosumer based energy management and sharing in smart grid. Renewable and Sustainable Energy Reviews. \url{https://www.sciencedirect.com/science/article/abs/pii/S1364032117310894}
    \item Sahoo, B. P. S., \& Rath, S. (2012). Integrating GPS, GSM and cellular phone for location tracking and monitoring. En Proceedings of the International Conference on Geospatial Technologies and Applications, Geomatrix'12. IIT Bombay. \url{https://arxiv.org/pdf/1307.3147}
    \item Sánchez Wevar, J. A. (2005). Análisis y Estudio de Redes GPRS (Tesis de pregrado). Universidad Austral de Chile. \url{http://cybertesis.uach.cl/tesis/uach/2005/bmfcis211a/doc/bmfcis211a.pdf}
    \item Semtech. (s. f.). Smart agriculture. \url{https://www.semtech.com/lora/lora-applications/smart-agriculture}
    \item Sepúlveda-Leiva, S. A., Suárez-Páez, J. E., \& Salcedo-González, M. L. (2013). Posibles Escenarios de Migración de Redes Móviles de 2G y 3G a Cuarta Generación en Colombia. TecnoLógicas, 381-394. \url{https://www.redalyc.org/pdf/3442/344234341029.pdf}
    \item Sepúlveda-Leiva, S. A., Suárez-Paéz, J. E., \& Salcedo-González, M. L. (2013). Posibles Escenarios de Migración de Redes Móviles de 2G y 3G a Cuarta Generación en Colombia. TecnoLógicas, 381-394. \url{https://revistas.uees.edu.ec/index.php/IRR/article/view/21/19}
    \item Sinelec. (2021). ¿Qué son las redes LPWAN?. \url{https://blog.gruposinelec.com/actualidad/que-son-las-redes-lpwan/}
    \item Slats, L. (2020). A brief history of LoRa®: Three inventors share their personal story at The Things Conference. Semtech Blog. \url{https://blog.semtech.com/a-brief-history-of-lora-three-inventors-share-their-personal-story-at-the-things-conference}
    \item Smelpro. (2026). LPWAN vs celular: Conectividad IoT de bajo consumo. \url{https://smelpro.com/lpwan-vs-celular-conectividad-iot-bajo-consumo/}
    \item Tarlogic. (2020). LoRaWAN 1.0, vulnerabilities and backward compatibility in version 1.1. Tarlogic Cybersecurity. \url{https://www.tarlogic.com/blog/lorawan-vulnerabilities-versions/}
    \item TEKTELIC. (2025, 7 de marzo). Comparación de LoRaWAN, NB-IoT, Sigfox y LTE: ¿Qué tecnología IoT es la adecuada para usted?. \url{https://tektelic.com/es/expertise/lorawan-vs-nb-iot-sigfox-and-lte-comparison/}
    \item Texto Único Ordenado de la Ley de Telecomunicaciones. (1993). Decreto Supremo N.° 013-93-TCC. Gob.pe. \url{https://www.gob.pe/institucion/mtc/normas-legales/807573-013-93-tcc}
    \item The Things Network. (s. f.). What are LoRa and LoRaWAN?. \url{https://www.thethingsnetwork.org/docs/lorawan/what-is-lorawan/}
    \item Tisal, J. (1999). La red GSM. Editorial: Parafino Thomson Learning. Dunod, París.
    \item Universidad Politécnica de Madrid. (2011). GSM (Sistema Global para las telecomunicaciones móviles). Ingeniatic. \url{https://www.etsist.upm.es/estaticos/ingeniatic/index.php/tecnologias/item/471-gsm-sistema-global-para-las-telecomunicaciones-m%C3%B3viles.html}
    \item Vilchez Román, M. A. Brecha de uso en internet en el Perú. Una descomposición para áreas rurales. \url{https://tesis.pucp.edu.pe/server/api/core/bitstreams/40070f3a-f122-4b8b-b71e-a9d8dbf30094/content}
    \item Wenner, R. (2017). LoRa CHIRP [Video]. YouTube. \url{https://www.youtube.com/watch?v=dxYY097QNs0}
    \item Wevar, J. A. S. (2005). Análisis y Estudio de redes GPRS. Trabajo para la titulación de Ingeniero Electrónico. \url{https://www.academia.edu/download/34982475/Analisis_y_Estudio_de_Redes_GPRS.pdf}
    \item Wray Castle. (2024). ¿Qué es GPRS? Conceptos básicos de la conectividad de datos móviles. \url{https://wraycastle.com/es/blogs/knowledge-base/what-is-gprs}
    \item Young, E. G. Parametric Analysis Of LoRa Sensor Network Data Rate And Packet Time On Air. \url{https://www.researchgate.net/publication/384054551_Parametric_Analysis_Of_LoRa_Sensor_Network_Data_Rate_And_Packet_Time_On_Air}
    \item Ziayi, P., Farmanbar, S., \& Rezvani, M. (2021). YAICD: Yet Another IMSI Catcher Detector in GSM. Security and Communication Networks, 2021, 8847803. \url{https://doi.org/10.1155/2021/8847803}
\end{enumerate}
