...
\begin{document}
	...
	\paragraph*{\textbf{\textit{GSM}}} \mbox{}\\
	...
	\textbf{\textit{	VLR}} \mbox{}\\
	
	El Visitor Location Register (VLR) es una base de datos temporal vinculada al MSC que almacena la información de los abonados presentes en su área de servicio. Cuando un usuario se desplaza a una nueva zona, el VLR intercambia información con el HLR para gestionar su ubicación y facilitar el establecimiento de llamadas y la prestación de servicios mientras permanece registrado en esa área (ETSI, 1996). \\

	\textbf{\textit{	HLR}} \mbox{}\\
...
\end{figure}	
	...
	\paragraph*{\textbf{\textit{GPRS}}} \mbox{}\\
	...
	\textbf{\textit{Espectro Ensanchado por Chirridos (CSS).}} \mbox{}\\
	
	“Esta es una tecnología de radiofrecuencia de alto alcance para comunicaciones inalámbricas” (Inpixon, s.f). Básicamente, este tipos de ondas, permiten distribuir señales de radio en un rango mucho más amplio que cualquier otro y de una manera un tanto diferente, a comparación de las ondas sinusoidales a las que se les puede modificar tanto la amplitud como la frecuencia para poder captar una información de distinta calidad, este tipo de espectro se divide en chirps ascendentes y descendentes \textbf{(figura 6)}, siendo estos, lineas rectas  que tienen como estándares de medida: velocidad de barrido y el ancho de banda \textbf{(figura 7)}.
	...
	\textbf{\textit{Spreading Factor}} \mbox{}\\
	...
	\textbf{\textit{Protocolo LoRaWAN.}} \mbox{}\\
	...
	La correlación entre estos dos conceptos se puede apreciar en la \textbf{figura 9}:
	\begin{figure}[H]
	...
	\paragraph*{}
	\textbf{\textit{Arquitectura de LoRaWAN.}} \mbox{}\\
	...
	Entre los casos más comunes de LoRaWAN en una ciudad inteligente, resaltan 6 en particular que se irán acotando por orden, tal y como se aprecia en la \textbf{figura 10:} 
