...
\begin{document}
	...
	\paragraph{Características de LoRa}~\\
	
	Las principales características de usar LoRa, junto a su protocolo como red designada para la trasmisión de datos en dispositivos de IoT son varías, entre las más destacadas se encuentran:
	\vspace{0.5cm}
	\begin{itemize}
	...
	\end{itemize}
	\paragraph{Arquitectura de LoRaWAN}~\\
	...
	\begin{figure}[H]
		...
		\vspace{0.3cm}
		\raggedright
		\small\textit{Nota: Se detallan las aplicaciones más comúnes en beneficio de la comunidad, estas por lo general se presentan en ciudades desarrolladas en conjunto con un gobierno al tanto de los avances tecnológicos.}
	\end{figure}
