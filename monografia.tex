...
\begin{document}
	...
	\begin{figure}[H]
		...
		\vspace{0.3cm}
		\raggedright
		\small\textit{Nota: Las redes disponibles dentro de Sudamérica.} \\ \vspace{0.1cm} Extraido de: Mayorga, M. [Articulo].
	\end{figure}
	...
	\begin{figure}[H]
		...
		\vspace{0.3cm}
		\raggedright
		\small\textit{Nota: Se observan las fases que pasa la red 3G.} \\ \vspace{0.1cm} Extraido de: Techpedia - Becvar, Z. [Libro].
	\end{figure}
	...
	\begin{figure}[H]
		...
		\vspace{0.3cm}
		\raggedright
		\small\textit{Nota: Actualizado con información reportada al 2026-I.} \\ \vspace{0.1cm} Extraido de: ResearchGate - Botran,X. [Informe].
	\end{figure}
	...
	\begin{figure}[H]
		...
		\vspace{0.3cm}
		\raggedright
		\small\textit{Nota: Se observan las fases que pasa la red 4G.} \\ \vspace{0.1cm} Extraido de: Udistrita - Constain, D. [Articulo].
	\end{figure}
	...
	\begin{figure}[H]
		...
		\vspace{0.3cm}
		\raggedright
		\small\textit{Nota: Se observan las fases que pasa la red 5G.} \\ \vspace{0.1cm} Extraido de: ResearchGate - Botran,X. [Articulo].
	\end{figure}
